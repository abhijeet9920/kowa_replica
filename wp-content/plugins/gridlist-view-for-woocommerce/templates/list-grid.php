...
?>
<!-- Uncomment this code for showing list and grid-->
<!--<div class="berocket_lgv_widget"<?php e//cho ' style="',( ( @ $position ) ? 'float:'.$position.';' : '' ), 'padding: '.( @ (int)$padding['top'] ? @ (int)$padding['top'] : '0' ).'px '.( @ (int)$padding['right'] ? @ (int)$padding['right'] : '0' ).'px '.( @ (int)$padding['bottom'] ? @ (int)$padding['bottom'] : '0' ).'px '.( @ (int)$padding['left'] ? @ (int)$padding['left'] : '0' ).'px;"'; ?>>
